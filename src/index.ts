...
import { registerApiKeyMcpRoutes } from "./routes/apiKeyMcp.js";
...
import { registerChatSessionRoutes } from "./routes/chatSessions.js";
...
async function main(): Promise<void> {
  ...
  await registerApiKeyMcpRoutes(fastify);
  ...
  await registerChatSessionRoutes(fastify);
